...
import { ChainId, JSBI, Percent, RoutablePlatform, Router, SwapParameters, Trade, TradeType } from '@dxdao/swapr-sdk'
        ...
        const estimatedCalls: EstimatedSwapCall[] = await Promise.all(
          swapCalls.map(call => {
            ...
            return contract.estimateGas[methodName](...args, {
              ...options,
              gasLimit: chainId === ChainId.XDAI ? 1000000 : undefined
            })
              .then(gasEstimate => {
                return {
                  call,
