...
export type FathomRegisteredNetworkName = 'ethereum' | 'rinkeby' | 'goerli' | 'optimism' | 'bsc' | 'gnosis' | 'polygon' | 'arbitrum' | 'arbitrum-rinkeby' | 'arbitrum-goerli';
...
export const siteEvents: FathomSiteInformation = {
  ...
  "timestamp": "2023-05-30T15:40:52.880Z"
};
