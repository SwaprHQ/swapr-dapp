      ...
      <svg width="100%" preserveAspectRatio="xMinYMin slice" viewBox="0 0 766 300">
        <defs>
          <linearGradient id="linear-gradient">
            <stop offset="0%" stopColor="#c8bdff" stopOpacity="0.4"></stop>
            <stop offset="33%" stopColor="#c8bdff" stopOpacity="0.4"></stop>
            <stop offset="50%" stopColor="#ffffff"></stop>
            <stop offset="67%" stopColor="#c8bdff" stopOpacity="0.4"></stop>
            <stop offset="100%" stopColor="#c8bdff" stopOpacity="0.4"></stop>
            <animateTransform
          ...
          <linearGradient id="area" x1="50%" y1="-104.497044%" x2="50%" y2="85.1203676%">
            <stop offset="0%" stopColor="#c8bdff" stopOpacity="0.4"></stop>
            <stop offset="100%" stopColor="#cc90ff" stopOpacity="0"></stop>
          </linearGradient>
        </defs>
