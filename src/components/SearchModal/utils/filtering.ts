...
export const filterTokens = (tokens: Token[], search: string): Token[] => {
...
export const filterPairs = (pairs: Pair[], search: string): Pair[] => {
...
export const useSortedTokensByQuery = (tokens: Token[] | undefined, searchQuery: string): Token[] => {
  return useMemo(() => {
    if (!tokens) {
      return []
    }
