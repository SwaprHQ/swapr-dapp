        ...
        >
          ...
          {type === 'dark-outline' && (
            <>
              ...
              <svg className="button-border-dark-outline">
                <use href="#button-border-dark-outline" />
              </svg>
            </>
          )}
          {type !== 'icon' ? (
  ...
  &.outline a {
    ...
    &:before {
      ...
      background: linear-gradient(
        122.39deg,
        rgba(61, 90, 254, 0.03) 0%,
        rgba(61, 90, 254, 0.6) 22.92%,
        rgba(169, 182, 255, 0.6) 46.35%,
        rgba(61, 90, 254, 0.6) 78.65%,
        rgba(61, 90, 254, 0.03) 100%
      );
    }
  }
  &.icon a {
